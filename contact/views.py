...
def contact_list(request):
    user = request.user
    message= "Contact vide"
    contact_list = Contact.objects.filter(auteur=user, archive=False)
    return render(request, "contacts/contact_list.html", {"contacts" : contact_list})
